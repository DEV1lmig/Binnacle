    ...
    <AuthLayout>
      <SignUp.Root routing="path" path="/sign-up">
        <SignUp.Step name="start" className="flex flex-col gap-6">
          ...
          {/* Captcha */}
          <SignUp.Captcha className="rounded-xl overflow-hidden mt-2" />
        ...
        <SignUp.Step name="continue" className="flex flex-col gap-6">
          <header className="mb-2">
            <h1 className="text-[2.5rem] font-bold text-gray-900 tracking-tight">Profile</h1>
            <p className="text-gray-500 font-medium text-sm mt-2">
              A few details to personalize your archive.
            </p>
          </header>
        ...
        <SignUp.Step name="verifications" className="flex flex-col gap-6">
          <SignUp.Strategy name="email_code">
            <header className="mb-2">
              <h1 className="text-[2rem] font-bold text-gray-900 tracking-tight">Verify email</h1>
              <p className="text-gray-500 font-medium text-sm mt-2">
